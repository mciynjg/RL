...
# keeps the script usable when launched as ``python utils/eval_rl_three_shot.py``.
REPO_ROOT = Path(__file__).resolve().parent.parent
PROMPT_PATH = REPO_ROOT / "prompts" / "r1_zero_three_shot_gsm8k.prompt"
DATA_PATH = REPO_ROOT / "data" / "gsm8k" / "train.jsonl"
RESULT_PATH = REPO_ROOT / "results" / "eval result" / "r1_zero_three_shot_gsm8k_base_eval.jsonl"
