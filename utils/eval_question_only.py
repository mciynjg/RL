...
PROMPT_PATH = Path(__file__).resolve().parent.parent / "prompts" / "question_only.prompt"
DATA_PATH = Path(__file__).resolve().parent.parent.parent / "data" / "gsm8k" / "train.jsonl"
RESULT_PATH = Path(__file__).resolve().parent / "results" / "question_only_gsm8k_base_eval.jsonl"
